...
Things I would add if this grew past a weekend project: optional sync via a small backend so the same data is available on a tablet during lessons, a per-lesson summary you can paste into a student's homework notes, and spaced-repetition prompts generated from persistent tags.
